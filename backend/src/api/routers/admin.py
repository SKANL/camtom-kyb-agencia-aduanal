...
def seed_demo(supabase=Depends(get_supabase_client)):
    ...
    exp2_id = _seed_expediente(
        ...
        docs=[
            {"doc_type": "csf", "fields": {"rfc": "COX010101AB1", "razon_social": "Corporativo Equis Distribuidora, SA de CV", "domicilio_fiscal": "Avenida Insurgentes Sur Num 123, Colonia Roma", "fecha_emision": hoy, "regimen_fiscal": "601 - General de Ley Personas Morales"}},
            ...
            {"doc_type": "poder_notarial", "fields": {"nombre_representante": "Carlos Eduardo Morales Ríos", "alcance": "Actos de Administración"}},
